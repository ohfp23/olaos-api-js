...
class EIP712Signer {
    ...
    static getSignedDigest(transaction) {
        ...
        return _TypedDataEncoder.hash(domain, eip712Types, EIP712Signer.getSignInput(transaction));
    }
}
...
function parseTransaction(payload) {
    ...
    if ((utils.hexlify(ethSignature.r) == "0x" || utils.hexlify(ethSignature.s) == "0x") &&
...
class OlaProvider extends providers.JsonRpcProvider {
    ...
    static getFormatter() {
        if (defaultFormatter == null) {
            ...
            defaultFormatter.formats.receipt.l2ToL1Logs = providers.Formatter.arrayOf((value) => providers.Formatter.check(defaultFormatter.formats.l2Tol1Log, value));
